...
export async function parcheInicio(req: Request, res: Response) {
    try {
        ...
        await usuarioModel.changeStatus(Number(viaje[0].id_usuario), "En ruta")
        await vehiculoModel.changeStatus(viaje[0].patente, "EN RUTA")
    } catch (e) {
        console.error(e)
            ...
            const actualizaEspera = await viajesModel.editarEspera(id,
                {
                    ...
                    kms_inicial: kms_inicial || viajeEncontrado[0].kms_inicio || 0,
