...
--
-- Table structure for table `solicitudes_viaje`
--
...
CREATE TABLE `solicitudes_viaje` (
  ...
  `estado` enum('resuelta','pendiente','rechazada') NOT NULL DEFAULT 'pendiente',
  `resuelta_por` varchar(100) DEFAULT NULL,
  `fecha_resuelta` datetime DEFAULT NULL,
  `id_solicitante` int NOT NULL,
  `solicitante` varchar(100) NOT NULL,
  `motivo` varchar(200) NOT NULL,
  `vehiculo_solicitado` varchar(50) DEFAULT NULL,
  `estado_texto` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id_solicitud`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `solicitudes_viaje`
--
